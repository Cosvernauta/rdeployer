...
# rdeploy // deploy para Jenkins con WebLogic
...
#
# desplegar la firma del componente, obtiene la firma de la ruta Jenkins
fnFirma()
{
...
#
# Configuraciones rdeployer: {componente}.conf
fnConfig()
{
   msg "Validando archivo de configuracion" "INFO"

   if [[ -f ${APDIR}/${APNAME}.conf ]]; then
      . ${APDIR}/${APNAME}.conf
